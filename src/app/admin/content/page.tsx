...
const AddLessonForm = ({ module, onClose, onSave, initialLesson }: { 
  ...
  const [timer, setTimer] = useState(initialLesson?.timer || 300);
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        <button onClick={() => setShowAddModule(true)} className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
          Add Module
        </button>
      </div>
